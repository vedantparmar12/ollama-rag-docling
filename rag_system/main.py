...
OLLAMA_CONFIG = {
    ...
    "generation_model": os.getenv("DEFAULT_GENERATION_MODEL", "llama3.2:latest"),  # Main text generation model
    "enrichment_model": os.getenv("DEFAULT_ENRICHMENT_MODEL", "smollm2:latest"),  # Lightweight model for routing/enrichment
}
