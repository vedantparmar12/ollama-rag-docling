    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur flex items-center justify-center z-50">
      <div className="bg-gray-900 w-[600px] max-h-[90vh] overflow-auto rounded-xl p-6 text-white space-y-6">
        ...
        <div className="space-y-4">
          <div>
            <label className="block text-sm mb-1">Document & Media files</label>
            <input type="file" accept="application/pdf,.docx,.doc,.pptx,.ppt,.xlsx,.xls,.html,.htm,.md,.txt,.mp3,.wav,.m4a,.flac" multiple onChange={handleFile} className="text-sm" />
            <p className="text-xs text-gray-400 mt-1">Supports: PDF, Word, PowerPoint, Excel, HTML, Markdown, and Audio (MP3, WAV, M4A, FLAC)</p>
          </div>
